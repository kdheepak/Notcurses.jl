...
function ncdirect_init(termtype, fp, flags)
  ccall((:ncdirect_init, notcurses), Ptr{ncdirect}, (Ptr{Cchar}, Ptr{Libc.FILE}, UInt64), termtype, fp, flags)
end

function ncdirect_core_init(termtype, fp, flags)
  ccall((:ncdirect_core_init, notcurses), Ptr{ncdirect}, (Ptr{Cchar}, Ptr{Libc.FILE}, UInt64), termtype, fp, flags)
end
...
function ncdirect_putstr(nc, channels, utf8)
  ccall((:ncdirect_putstr, notcurses), Cint, (Ptr{ncdirect}, UInt64, Ptr{Cchar}), nc, channels, utf8)
end

function ncdirect_putegc(nc, channels, utf8, sbytes)
  ccall((:ncdirect_putegc, notcurses), Cint, (Ptr{ncdirect}, UInt64, Ptr{Cchar}, Ptr{Cint}), nc, channels, utf8, sbytes)
end
...
function ncdirect_supported_styles(nc)
  ccall((:ncdirect_supported_styles, notcurses), UInt16, (Ptr{ncdirect},), nc)
end
...
function ncdirect_styles(n)
  ccall((:ncdirect_styles, notcurses), UInt16, (Ptr{ncdirect},), n)
end
...
function ncdirect_capabilities(n)
  ccall((:ncdirect_capabilities, notcurses), Ptr{nccapabilities}, (Ptr{ncdirect},), n)
end

function ncdirect_hline_interp(n, egc, len, h1, h2)
  ccall((:ncdirect_hline_interp, notcurses), Cint, (Ptr{ncdirect}, Ptr{Cchar}, Cuint, UInt64, UInt64), n, egc, len, h1, h2)
end

function ncdirect_vline_interp(n, egc, len, h1, h2)
  ccall((:ncdirect_vline_interp, notcurses), Cint, (Ptr{ncdirect}, Ptr{Cchar}, Cuint, UInt64, UInt64), n, egc, len, h1, h2)
end

function ncdirect_box(n, ul, ur, ll, lr, wchars, ylen, xlen, ctlword)
  ccall((:ncdirect_box, notcurses), Cint, (Ptr{ncdirect}, UInt64, UInt64, UInt64, UInt64, Ptr{Cwchar_t}, Cuint, Cuint, Cuint), n, ul, ur, ll, lr, wchars, ylen, xlen, ctlword)
end

function ncdirect_light_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
  ccall((:ncdirect_light_box, notcurses), Cint, (Ptr{ncdirect}, UInt64, UInt64, UInt64, UInt64, Cuint, Cuint, Cuint), n, ul, ur, ll, lr, ylen, xlen, ctlword)
end

function ncdirect_heavy_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
  ccall((:ncdirect_heavy_box, notcurses), Cint, (Ptr{ncdirect}, UInt64, UInt64, UInt64, UInt64, Cuint, Cuint, Cuint), n, ul, ur, ll, lr, ylen, xlen, ctlword)
end

function ncdirect_ascii_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
  ccall((:ncdirect_ascii_box, notcurses), Cint, (Ptr{ncdirect}, UInt64, UInt64, UInt64, UInt64, Cuint, Cuint, Cuint), n, ul, ur, ll, lr, ylen, xlen, ctlword)
end

function ncdirect_rounded_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
  ccall((:ncdirect_rounded_box, notcurses), Cint, (Ptr{ncdirect}, UInt64, UInt64, UInt64, UInt64, Cuint, Cuint, Cuint), n, ul, ur, ll, lr, ylen, xlen, ctlword)
end

function ncdirect_double_box(n, ul, ur, ll, lr, ylen, xlen, ctlword)
  ccall((:ncdirect_double_box, notcurses), Cint, (Ptr{ncdirect}, UInt64, UInt64, UInt64, UInt64, Cuint, Cuint, Cuint), n, ul, ur, ll, lr, ylen, xlen, ctlword)
end
...
function ncdirect_get(n, absdl, ni)
  ccall((:ncdirect_get, notcurses), UInt32, (Ptr{ncdirect}, Ptr{Cvoid}, Ptr{ncinput}), n, absdl, ni)
end
...
function ncdirect_get_nblock(n, ni)
  ccall((:ncdirect_get_nblock, notcurses), UInt32, (Ptr{ncdirect}, Ptr{ncinput}), n, ni)
end

function ncdirect_get_blocking(n, ni)
  ccall((:ncdirect_get_blocking, notcurses), UInt32, (Ptr{ncdirect}, Ptr{ncinput}), n, ni)
end
...
function ncdirect_render_image(n, filename, align, blitter, scale)
  ccall((:ncdirect_render_image, notcurses), Cint, (Ptr{ncdirect}, Ptr{Cchar}, ncalign_e, ncblitter_e, ncscale_e), n, filename, align, blitter, scale)
end

function ncdirect_render_frame(n, filename, blitter, scale, maxy, maxx)
  ccall((:ncdirect_render_frame, notcurses), Ptr{ncdirectv}, (Ptr{ncdirect}, Ptr{Cchar}, ncblitter_e, ncscale_e, Cint, Cint), n, filename, blitter, scale, maxy, maxx)
end

function ncdirect_raster_frame(n, ncdv, align)
  ccall((:ncdirect_raster_frame, notcurses), Cint, (Ptr{ncdirect}, Ptr{ncdirectv}, ncalign_e), n, ncdv, align)
end
...
function ncdirectf_geom(n, frame, vopts, geom)
  ccall((:ncdirectf_geom, notcurses), Cint, (Ptr{ncdirect}, Ptr{ncdirectf}, Ptr{ncvisual_options}, Ptr{ncvgeom}), n, frame, vopts, geom)
end
...
function ncdirect_stream(n, filename, streamer, vopts, curry)
  ccall((:ncdirect_stream, notcurses), Cint, (Ptr{ncdirect}, Ptr{Cchar}, ncstreamcb, Ptr{ncvisual_options}, Ptr{Cvoid}), n, filename, streamer, vopts, curry)
end
...
function ncdirect_cantruecolor(n)
  ccall((:ncdirect_cantruecolor, notcurses), Bool, (Ptr{ncdirect},), n)
end

function ncdirect_canchangecolor(n)
  ccall((:ncdirect_canchangecolor, notcurses), Bool, (Ptr{ncdirect},), n)
end

function ncdirect_canfade(n)
  ccall((:ncdirect_canfade, notcurses), Bool, (Ptr{ncdirect},), n)
end

function ncdirect_canopen_images(n)
  ccall((:ncdirect_canopen_images, notcurses), Bool, (Ptr{ncdirect},), n)
end

function ncdirect_canopen_videos(n)
  ccall((:ncdirect_canopen_videos, notcurses), Bool, (Ptr{ncdirect},), n)
end

function ncdirect_canutf8(n)
  ccall((:ncdirect_canutf8, notcurses), Bool, (Ptr{ncdirect},), n)
end
...
function ncdirect_canhalfblock(nc)
  ccall((:ncdirect_canhalfblock, notcurses), Bool, (Ptr{ncdirect},), nc)
end

function ncdirect_canquadrant(nc)
  ccall((:ncdirect_canquadrant, notcurses), Bool, (Ptr{ncdirect},), nc)
end

function ncdirect_cansextant(nc)
  ccall((:ncdirect_cansextant, notcurses), Bool, (Ptr{ncdirect},), nc)
end

function ncdirect_canbraille(nc)
  ccall((:ncdirect_canbraille, notcurses), Bool, (Ptr{ncdirect},), nc)
end

function ncdirect_canget_cursor(nc)
  ccall((:ncdirect_canget_cursor, notcurses), Bool, (Ptr{ncdirect},), nc)
end
